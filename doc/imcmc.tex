...
\insertcode{"../examples/gaussian.cpp"}{Example of multi-dimensional Gaussian likelihood distribution.} % The first argument is the script location/filename and the second is a caption for the listing
