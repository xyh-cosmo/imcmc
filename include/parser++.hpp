...
namespace parser{
    ...
    //  check whether the given line is commented, if commented, true will be return
	...
	//	int to string
        ...
        std::string DoubleToString( double par, int precision=5 );
    ...
    //  read in one string/int/double from returned value, also, must be called when there is only
    //  ONE value
